...
Естественно, внутренний API для правил намного богаче и позволяет эффективно делать любые проверки кода. Ознакомиться детальнее можно в [документации][eslint_rules]. Но самое важно, что небольшие правила можно написать **быстро и легко**.
